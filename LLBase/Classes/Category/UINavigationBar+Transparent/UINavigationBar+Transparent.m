...
- (void)js_setBackgroundColor:(UIColor *)backgroundColor
{
    if (!self.customView) {
        ...
        self.customView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, 64)];
        self.customView.backgroundColor = [UIColor clearColor];
        [self addSubview:self.customView];
        
        [[self.subviews firstObject] insertSubview:self.customView atIndex:0];
    }
